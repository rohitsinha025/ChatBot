...
public class WaitHelper {
	...
	public void setExplicitWait(int value) throws InterruptedException {
		Thread.sleep(value);
	}
	...
	public void waitForElementAndSwitchToiframe(WebDriver driver, long time, WebElement element) {
		WebDriverWait wait = new WebDriverWait(driver, time);
